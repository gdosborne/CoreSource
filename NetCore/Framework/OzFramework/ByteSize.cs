    ...
    public struct ByteSize : IComparable<ByteSize>, IEquatable<ByteSize> {
        ...
        public string LargestWholeNumberSymbol {
            get {
                ...
                if (System.Math.Abs(PetaBytes) >= 1) {
                    return ByteSize.PetaByteSymbol;
                }

                if (System.Math.Abs(TeraBytes) >= 1) {
                    return ByteSize.TeraByteSymbol;
                }

                if (System.Math.Abs(GigaBytes) >= 1) {
                    return ByteSize.GigaByteSymbol;
                }

                if (System.Math.Abs(MegaBytes) >= 1) {
                    return ByteSize.MegaByteSymbol;
                }

                if (System.Math.Abs(KiloBytes) >= 1) {
                    return ByteSize.KiloByteSymbol;
                }

                if (System.Math.Abs(Bytes) >= 1) {
        ...
        public string ToString(string format, IFormatProvider provider) {
            ...
            Func<string, bool> has = s => format.IndexOfIgnoreCase(s) != -1;
